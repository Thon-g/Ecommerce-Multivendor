...
public class SellerConstant {
    ...
    public static final String SALT_TAG = "SHOP";
    ...
    public static final String GET_CURRENT_SELLER_SUCCESS = "Lấy thông tin gian hàng thành công.";
    ...
    public static final String SELLER_PENDING_EXISTS = "Hồ sơ đăng ký của bạn đang chờ phê duyệt. Vui lòng không gửi lại.";
    public static final String SELLER_BANNED = "Tài khoản của bạn đã bị cấm đăng ký bán hàng trên hệ thống.";
